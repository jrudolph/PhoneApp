...
{   
    ...
    public SipRingtonePreference(Context context) 
    {
        super(context);
    	mContext = context;
    }
    ...
    {    	
        ...
        ringtonePickerIntent.putExtra(RingtoneManager.EXTRA_RINGTONE_TITLE,
        		mContext.getString(R.string.settings_sipringtone_dialog));
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(Sipdroid.PREF_RINGTONE, ringtoneUri != null ? ringtoneUri.toString() : "");				
		edit.commit();        
    }
